...
const MediumAdditionScene_1 = require("../components/Scenes/MediumAdditionScene");
const SmallSubtractionScene_1 = require("../components/Scenes/SmallSubtractionScene");
const MediumSubtractionScene_1 = require("../components/Scenes/MediumSubtractionScene");
...
const MathVideo = ({ script, audioUrl, audioUrls, sceneDurations }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(remotion_1.AbsoluteFill, { style: { backgroundColor: BG_COLOR }, children: [(0, jsx_runtime_1.jsx)("div", { style: {
                    ...
                    pointerEvents: "none",
                } }), visualGroups.map((group, i) => ((0, jsx_runtime_1.jsx)(remotion_1.Sequence, { from: group.start, durationInFrames: group.durationInFrames, children: (0, jsx_runtime_1.jsx)(remotion_1.AbsoluteFill, { children: group.action === "SHOW_COLUMN_ARITHMETIC" ? ((0, jsx_runtime_1.jsx)(ColumnArithmeticScene_1.ColumnArithmeticScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : group.action === "SHOW_SMALL_ADDITION" ? ((0, jsx_runtime_1.jsx)(SmallAdditionScene_1.SmallAdditionScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : group.action === "SHOW_MEDIUM_ADDITION" ? ((0, jsx_runtime_1.jsx)(MediumAdditionScene_1.MediumAdditionScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : group.action === "SHOW_SMALL_SUBTRACTION" ? ((0, jsx_runtime_1.jsx)(SmallSubtractionScene_1.SmallSubtractionScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : group.action === "SHOW_MEDIUM_SUBTRACTION" ? ((0, jsx_runtime_1.jsx)(MediumSubtractionScene_1.MediumSubtractionScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : group.action === "SHOW_NUMBER_ORDERING" ? ((0, jsx_runtime_1.jsx)(NumberOrderingScene_1.NumberOrderingScene, { groupedScenes: group.subScenes.map(s => s.scene), timings: group.subScenes })) : (sceneComponent(group.subScenes[0].scene)) }) }, `visual-${i}`))), script.scenes.map((scene, i) => (scene.action === "SHOW_COLUMN_ARITHMETIC" || scene.action === "SHOW_SMALL_ADDITION" || scene.action === "SHOW_MEDIUM_ADDITION" || scene.action === "SHOW_SMALL_SUBTRACTION" || scene.action === "SHOW_MEDIUM_SUBTRACTION" || scene.action === "SHOW_NUMBER_ORDERING" ? null : ((0, jsx_runtime_1.jsx)(remotion_1.Sequence, { from: sceneStarts[i].start, durationInFrames: sceneStarts[i].dur, children: (0, jsx_runtime_1.jsx)(remotion_1.AbsoluteFill, { children: (0, jsx_runtime_1.jsx)(Scenes_1.NarrationBar, { text: scene.narration }) }) }, `narration-${i}`)))), audioUrls && audioUrls.length > 0 ? (audioUrls.map((url, i) => (url ? ((0, jsx_runtime_1.jsx)(remotion_1.Sequence, { from: sceneStarts[i].start + Math.round(fps * 0.5), children: (0, jsx_runtime_1.jsx)(remotion_1.Audio, { src: url }) }, i)) : null))) : audioUrl ? ((0, jsx_runtime_1.jsx)(remotion_1.Sequence, { from: 0, children: (0, jsx_runtime_1.jsx)(remotion_1.Audio, { src: audioUrl }) })) : null] }));
};
