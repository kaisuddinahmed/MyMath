...
const MathVideo_1 = require("./compositions/MathVideo");
const FPS = 24;
...
const RemotionRoot = () => {
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(remotion_1.Composition, { id: "MathVideo", component: MathVideo_1.MathVideo, durationInFrames: FPS * 30, fps: FPS, width: 1280, height: 720, defaultProps: {
                ...
                function getVisualFrames(scene) {
                    if (scene.action === "SHOW_EQUATION")
                        return 30;
                ...
                for (let i = 0; i < (props.script?.scenes || []).length; i++) {
                    ...
                    if (url) {
                        try {
                            const audioSecs = await (0, media_utils_1.getAudioDurationInSeconds)(url);
