...
exports.NumberOrderingScene = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const remotion_1 = require("remotion");
const NumberOrderingScene = ({ groupedScenes, timings }) => {
    ...
    // Parse numbers
    const parseNumbers = (eq) => eq.split(",").map((s) => parseInt(s.trim(), 10)).filter((n) => !isNaN(n));
    ...
    // Transition progress
    const transitionProgress = (0, remotion_1.spring)({
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: {
            ...
            gap: gap,
            position: "relative",
        }, children: (0, jsx_runtime_1.jsx)("div", { style: { position: "relative", width: containerWidth, height: itemWidth }, children: mappedElements.map((el, i) => {
                const destIdx = destinationIndices[i];
                // Calculate X positions
                const xStart = i * (itemWidth + gap);
                const xEnd = destIdx * (itemWidth + gap);
                const currentX = (0, remotion_1.interpolate)(transitionProgress, [0, 1], [xStart, xEnd]);
                // Pop in animation for the initial entry
                const popIn = (0, remotion_1.spring)({
                ...
                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                        ...
                        transformOrigin: "bottom center",
                                ...
                                gap: blockGap,
                                marginBottom: gap,
                            }, children: Array.from({ length: el.num }).map((_, bIdx) => {
                                return ((0, jsx_runtime_1.jsx)("div", { style: {
                            ...
                            }, children: el.num })] }, `tower-${i}`));
            }) }) }));
};
exports.NumberOrderingScene = NumberOrderingScene;
